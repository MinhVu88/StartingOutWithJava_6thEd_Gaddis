package Checkpoint.Ch4;

public class cp410_411_412pg216 {
	public static void main(String[] args) {
		...
		for(int oddNo = 1; oddNo <= 49; oddNo += 2) {
		...
		for(int fifthNo = 5; fifthNo <= 95; fifthNo += 10) {
			System.out.println(fifthNo + "th");
		}
	}
}
