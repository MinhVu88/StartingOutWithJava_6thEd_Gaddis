...
public class cp323pg153 {
    public static void main(String[] args) {
        /*a) if (x > y)
                ...
                z = 20;
        */
        int x = Integer.parseInt(JOptionPane.showInputDialog("x: ")), y = Integer.parseInt(JOptionPane.showInputDialog("y: ")), z;
        JOptionPane.showMessageDialog(null,"z = " + (z = x > y ? 1 : 20));
